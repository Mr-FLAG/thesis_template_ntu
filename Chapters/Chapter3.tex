...
In this chapter, we study the problem of achieving max-min fair resource allocation in distributed job execution with task transmissions. The problem includes computing both the resource allocation and the demand transmission across the system. We focus on the online setting where jobs arrive dynamically for execution. Our goal is to guarantee the fairness of resource allocation among jobs while improving the system utilization.
