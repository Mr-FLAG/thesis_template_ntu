...
\begin{definition}
    A job $J_i$ is \textbf{servable} if and only if $\forall l \in [i-1]$, $s_{l} > 0$.
\end{definition}

\begin{definition}
    A job $J_i$ is \textbf{completable} if and only if $\forall l \in [i-1]$, $s_{l} \ge w_{i}$.
\end{definition}
